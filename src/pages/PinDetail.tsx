...
function PinDetail() {
  ...
  const fetchPin = async () => {
    try {
      const response = await axios.get(`https://mypythonwebapp-edcjb3e3a0f5apg6.polandcentral-01.azurewebsites.net/api/pins/${id}`, {
  ...
  const fetchComments = async () => {
    ...
    try {
      const response = await axios.get(`https://mypythonwebapp-edcjb3e3a0f5apg6.polandcentral-01.azurewebsites.net/api/pins/${id}/comments`, {
        headers: { Authorization: `Bearer ${token}` }
      });
  ...
  const handleSave = async () => {
    ...
    try {
      if (pin?.is_saved) {
        await axios.delete(`https://mypythonwebapp-edcjb3e3a0f5apg6.polandcentral-01.azurewebsites.net/api/pins/${id}/save`, {
          headers: { Authorization: `Bearer ${token}` }
        });
        setSnackbar({
          open: true,
        ...
        await axios.post(`https://mypythonwebapp-edcjb3e3a0f5apg6.polandcentral-01.azurewebsites.net/api/pins/${id}/save`, {}, {
          headers: { Authorization: `Bearer ${token}` }
        });
        setSnackbar({
          open: true,
  ...
  const handlePostComment = async () => {
    ...
    try {
      await axios.post(
        `https://mypythonwebapp-edcjb3e3a0f5apg6.polandcentral-01.azurewebsites.net/api/pins/${id}/comments`,
        { content: comment },
        { headers: { Authorization: `Bearer ${token}` } }
      );
      setComment('');
        ...
        <Grid container>
          ...
          <Grid item xs={12} md={8}>
            <Box sx={{ 
              ...
              <img
                src={`https://mypythonwebapp-edcjb3e3a0f5apg6.polandcentral-01.azurewebsites.net${pin.image_url}`}
                alt={pin.title}
                style={{
                  width: '100%',
                  height: '100%',
